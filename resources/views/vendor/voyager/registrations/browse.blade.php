...
@section('page_title', __('voyager::generic.viewing').' '. 'Inscriptions')

@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="{{ $dataType->icon }}"></i> Insriptions
        </h1>
        ...
        @endif
        @endcan
        <a href="{{ route('exportCSV') }}" class="btn btn-primary btn-add-new">
            <i class="voyager-plus"></i> <span>Exporter la liste (CSV)</span>
            </a>
